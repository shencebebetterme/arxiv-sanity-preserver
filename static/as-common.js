...
function addPapers(num, dynamic) {
  ...
  for(var i=0;i<num;i++) {
    ...
    //ldiv.append('a').attr('href', pdf_link).attr('target', '_blank').html('pdf');
    ldiv.append('a').attr('href', "static/pdf/".concat(p.link.substring(21,)).concat(".pdf")).attr('target','_blank').html('pdf')  
    ...
    // the function(pid){} is a function with one variable, and this function acts on p.pid
