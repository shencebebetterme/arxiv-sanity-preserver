...
for pid,p in db.items():
  ...
  #dict_id = makedict(p['_rawid'], forceidf=None, scale=5)
  ...
  #search_dict[pid] = merge_dicts([dict_id, dict_authors, dict_categories, dict_summary])
